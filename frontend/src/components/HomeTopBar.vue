...
<template>
  <div
    :class="['fixed top-0 left-0 w-full flex items-center flex-row-reverse p-4 transition-transform duration-300', isHidden ? '-translate-y-full' : 'translate-y-0', 'bg-white/30 dark:bg-gray-900/30 backdrop-blur-md', 'border-b border-gray-300/50 dark:border-gray-700/50', 'z-50']">
    <button type="button"
